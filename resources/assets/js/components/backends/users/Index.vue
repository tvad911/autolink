	                        ...
	                        <table class="table table-hover">
	                        	<tbody v-if="items">
	                        		<tr>
		                                ...
		                                <th>
		                                    Username
		                                    <a href="#" @click.prevent="sortListItem('username')"><i class="fa" v-bind:class="sortClass('username')"></i></a>
		                                </th>
		                                <th>
		                                	Email
		                                	<a href="#" @click.prevent="sortListItem('email')"><i class="fa" v-bind:class="sortClass('email')"></i></a>
	                                	</th>
		                                <th>
		                                	Name
...
<script>
	...
	import headermodule from '../../import/HeaderModule.vue';
    ...
    export default {
        ...
        methods: {
    		...
    		countAll(){
    			axios.get(site_url + 'api/user/count', {
    				params: {
    					all: this.all,
    					status: this.status,
    					inTrash: this.inTrash,
            ...
            submitDeletedItem(data){
            	...
            	if(data.deleted != 0)
            	{
            		this.$refs.toastr.Add({
	                    title: "Deleted User", // Toast Title
            ...
            submitCreatedItem(data){
        		...
        		{
        			this.$refs.toastr.Add({
					    title: "Created User", // Toast Title
					    msg: data.message, // Message
					    clickClose: true, // Click Close Disable
					    timeout: 6000, // Remember defaultTimeout is 5 sec..
					    progressBarValue: 0, // Manually update progress bar value later; null (not 0) is default
            ...
            updateMulti(){
            	axios.post(site_url + 'api/user/updatemulti', {
					items: this.selected,
