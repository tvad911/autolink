		    ...
		    <div class="row">
		        ...
		        <div class="col-sm-6">
		            <div id="example1_filter" class="dataTables_filter pull-right">
						<searchcategorybackend @searchData="searchData"></searchcategorybackend>
		            </div>
		        </div>
		    </div>
		</div>
...
<script>
	import showbackend from './ShowBackend.vue';
	import searchcategorybackend from './SearchCategoryBackend.vue';
    export default {
        components: { showbackend, searchcategorybackend },
        props: {
        	count:{
            	type: Object,
                required: true
